  ...
  return (
    <main className="max-w-[1900px] mx-auto">
      ...
      >
        ...
        >
          <div className="w-full pl-6 lg:pl-12 pt-8 pb-0 rounded-3xl gradient text-white text-center lg:text-left md:flex gap-8">
            <div className="max-sm:pb-6 max-md:pr-6 mb-2 md:mb-6 flex flex-col md:justify-center md:w-[60%]">
              <h1 className="font-extrabold mb-4 text-3xl">
                {t("teleconsultation.hero.titreHero")}
              </h1>
              <p className="mb-4">{t("teleconsultation.hero.paraph")}</p>
              <p className="flex sm:hidden md:flex font-bold mb-4 justify-center lg:justify-start">
      ...
      <motion.section
        ...
        variants={staggerContainer}
      >
        <h2 className="text-blue-primary font-bold text-center text-3xl md:text-4xl mb-12">
          ...
          {items.map((item, index) => (
            ...
            >
              <div className="flex items-center mb-4">
                <div className="bg-blue-primary w-12 h-12 rounded-xl flex items-center justify-center">
                  <img src={item.icon} alt="" className="w-6 h-6" loading="lazy" />
                </div>
                <h3 className="text-blue-primary font-bold ml-4">{item.title}</h3>
              </div>
